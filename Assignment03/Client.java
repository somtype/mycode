...
public class Client implements Runnable{
    ...
    static List<String> filenames; //需要的文件列表
    ...
    public Client(){
        ...
        for(int i = 0; i < threadsNum; i++){
            threads[i] = new ClientThread(filenames);
    ...
    public static void main(String[] args) throws Exception {
        ...
        timer.schedule(new TimerTask(){
            @Override
            public void run(){
                System.out.println("吞吐量: " + WebRequestMaker.totalBytes/time2wait + "Bps");
                System.exit(1);
            }
        },1000 * time2wait);
